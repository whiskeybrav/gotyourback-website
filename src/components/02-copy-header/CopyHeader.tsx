...
export default (): JSX.Element => <div className="section has-background-primary has-background-dirt" style={{ backgroundImage: `url(${bg})` }}>
	<div className="container has-text-centered has-text-light">
		...
		<h2 className="block is-size-2">
			...
			{" "}Who has #gotyourback?{" "}
			Take a moment to recognize those you’re grateful for. Show them the strength they provide you by doing 5 pushups with an object on your back and nominating 3 people to keep the chain of gratitude going. Post on social with #gotyourback and tag @whiskeybrav		</h2>
		<h1 className="is-size-1 has-text-centered">
